        ...
        {/* 
                    ...
                    <span className="sidebar-item border border-success rounded ps-1 pe-2 py-1" title='Verify your ID'>
                        <Link to={ route('home.my-profile') + '#verify-id' } className="text-decoration-none text-secondary d-flex align-items-center column-gap-1">
                            ...
                            <span className="fs-6 fw-bold">Verify Your ID</span>
                        </Link>
                    </span>
                    } */}
                </div>
                ...
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Home</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.notifications.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Notifications</span>
                    </Link>
                </span>
                {/* <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.streams.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Streams</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                ...
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.chats.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Chats</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.bookmarks.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Bookmarks</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.subscriptions.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Subscriptions</span>
                    </Link>
                </span>

                { (user.role.title == 'super-admin' || user.role.title == 'admin' || user.role.title == 'creator') && 
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.subscriptions.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#4c5661" className="bi bi-person-hearts" viewBox="0 0 16 16">
                            <path fillRule="evenodd" d="M11.5 1.246c.832-.855 2.913.642 0 2.566-2.913-1.924-.832-3.421 0-2.566M9 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-9 8c0 1 1 1 1 1h10s1 0 1-1-1-4-6-4-6 3-6 4m13.5-8.09c1.387-1.425 4.855 1.07 0 4.277-4.854-3.207-1.387-5.702 0-4.276ZM15 2.165c.555-.57 1.942.428 0 1.711-1.942-1.283-.555-2.281 0-1.71Z"/>
                        </svg>
                        <span className="fs-6 fw-semibold">Fans</span>
                    </Link>
                </span>
                }
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.wallet.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Wallet</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.cards.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Cards</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.stats.index') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">Stats</span>
                    </Link>
                </span>
                <span className="sidebar-item d-none d-md-block">
                    <Link to={ route('home.my-profile') } className="text-decoration-none text-secondary d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold">My profile</span>
                    </Link>
                </span>
                ...
                <span className="sidebar-item d-none d-md-block mt-3" style={{ marginLeft: '-4px' }}>
                    <button onClick={ logoutUser } className="text-decoration-none text-secondary border-0 bg-transparent d-flex align-items-center column-gap-3">
                        ...
                        <span className="fs-6 fw-semibold text-danger">Sign Out</span>
                    </button>
                </span>
            </aside>
            ...
            {/* Mobile Nav */}
            <aside className='mobile-nav card rounded-0'>
                <div className='d-flex justify-content-around align-items-center py-2'>
                    <Link to={ route('home.index' )} className='home'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4c5661" className="bi bi-house" style={{ paddingTop: '-3px' }}
                            viewBox="0 0 16 16">
                            <path
                                d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
                        </svg>
                    ...
                    <Link to={ route('home.notifications.index' )} className='notifications'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4c5661" className="bi bi-bell"
                            viewBox="0 0 16 16">
                            <path
                                d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2M8 1.918l-.797.161A4 4 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4 4 0 0 0-3.203-3.92zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5 5 0 0 1 13 6c0 .88.32 4.2 1.22 6" />
                        </svg>
                    ...
                    <Link to={ route('home.index') + '#new-post' } className='compose-message'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4c5661" className="bi bi-plus-circle-fill"
                            viewBox="0 0 16 16">
                            <path
                                d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v3h-3a.5.5 0 0 0 0 1h3v3a.5.5 0 0 0 1 0v-3h3a.5.5 0 0 0 0-1h-3z" />
                        </svg>
                    ...
                    <Link to={ route('home.chats.index' )} className='chats'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#4c5661" className="bi bi-chat-left-text" style={{ paddingTop: '2px' }}
                            viewBox="0 0 16 16">
                            <path
                                d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z" />
                            <path
            ...
            {/* Mobile Nav Modal */}
            { additionalNavVisible &&
                <div className="additional-mobile-nav card overflow-y-auto z-3" id="additionalMobileNav">
                    <div className="pt-4 pb-5 ps-3 pe-5 d-flex flex-column gap-3">
                ...
                {/* 
                        ...
                        <span className="align-self-stretch">
                            <Link to={ route('home.index') + '#new-post' } className="text-decoration-none text-light">
                                <div className="d-flex align-items-center column-gap-3 bg-dark rounded-pill py-1 px-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#fff" className="bi bi-plus mb-1"
                                    viewBox="0 0 16 16">
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4" />
                                    </svg>
