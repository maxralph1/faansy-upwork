...
import { usePostPublic } from '@/hooks/usePostPublic.jsx';
...
export default function Show() {
    ...
    const { post, getPost } = usePostPublic(params.id);
    ...
    return (
            <section className="col-sm-12 col-md-12 card rounded-0 mid-body">
                    ...
                    <div className={ `card-body ${ post?.data?.repost == true && 'px-5' }` }>
                        <div className="d-flex justify-content-between mb-3">
                            ...
                            <div className="d-flex column-gap-3">
                                ...
                                { user && (post?.data?.user?.id == user?.id && 
                    ...
                    <section className="px-2 d-flex justify-content-between align-items-center pt-3">
                        ...
                        <div className="mb-2 d-flex justify-content-start align-items-center column-gap-3">
                            ...
                            <span className='like-section'>
                                {user && ((post?.data?.likes?.length > 0) && post?.data?.likes?.find(foundLike => foundLike?.user?.id == user?.id)
                                    ? 
                                    <button 
                                        onClick={ async () => {
